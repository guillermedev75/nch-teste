function changeContent(){
    ...
    document.querySelector(".content1 img").setAttribute("src","/nch-teste/assets/page2/content1.png");
    document.querySelector(".content2 img").setAttribute("src","/nch-teste/assets/page2/content2.png");
    document.getElementById("textContent").setAttribute("src","/nch-teste/assets/page2/text1.png");
    document.querySelector(".content3 img").setAttribute("src","/nch-teste/assets/page2/content3.png");
    document.querySelector(".content4 img").setAttribute("src","/nch-teste/assets/page2/content4.png");
    document.querySelector(".content5 img").setAttribute("src","/nch-teste/assets/page2/content5.png");
...
function changeContent2(){
    ...
    document.querySelector(".content1 img").setAttribute("src","/nch-teste/assets/page1/content-test2.png");
    document.querySelector(".content2 img").setAttribute("src","/nch-teste/assets/page1/content-test3.png");
    document.getElementById("textContent").setAttribute("src","/nch-teste/assets/page1/text-content1.png");
    document.querySelector(".content3 img").setAttribute("src","/nch-teste/assets/page1/content-test1.png");
    document.querySelector(".content4 img").setAttribute("src","/nch-teste/assets/page1/content-test4.png");
    document.querySelector(".content5 img").setAttribute("src","/nch-teste/assets/page1/content-test5.png");
